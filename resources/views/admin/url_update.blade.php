                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" id="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control required" value="{{$res->page_name}}" name="page_name" placeholder="Page Name">
                                </div>

                                <div class="form-group">
                                    <label for="page_id">*Page Id</label>
                                    <input type="text" required class="form-control required" value="{{$res->page_id}}" name="page_id" placeholder="Page Id">
                                </div>

                                <div class="form-group">
                                    <p>Page Status：</p>
                                    <label><input name="status" value="1" type="radio"  @if($res->status == '1') checked @endif /><span></span>Published</label>
                                    <label><input name="status" value="0" type="radio" @if($res->status == '0') checked @endif/><span></span>Unpublished</label>
                                </div>

                                <div class="form-group">
                                    <p>是否申诉：</p>
                                    <label><input name="is_verify" value="1" type="radio" @if($res->is_verify=='1') checked @endif/><span></span>已申诉</label>
                                    <label><input name="is_verify" value="0" type="radio" @if($res->is_verify=='0') checked @endif/><span></span>未申诉</label>
                                </div>
