                ...
                <form class="forms-sample">
                    <div class="form-group" style="width:20rem">
                        ...
                        <div class="input-group col-xs-3">
                            <input type="text" style="width: 2.5rem;height: calc(2.875rem );margin-right: 10px"  class="form-control required calendar1" @if($time1) value="{{$time1}}" @endif name="time1" placeholder="开始时间">
                            <input type="text" style="width: 2.5rem;height: calc(2.875rem );margin-right: 10px"  class="form-control required calendar2" @if($time2) value="{{$time2}}" @endif name="time2" placeholder="结束时间">
                ...
                <div class="scroll-box">
                    ...
                    @foreach($list as $k=>$v)
                        <tr>
                            ...
                            <td>{{isset($v->upltv_revenue) ?round($v->upltv_revenue,0) : '0.00'}}</td>
                            <td>
                ...
                <div class="scroll-box">
                    ...
                    @foreach($list as $k=>$v)
                        <tr>
                            ...
                            <td>{{isset($v->upltv_revenue) ?$v->upltv_revenue : '0.00'}}</td>
                            <td>
