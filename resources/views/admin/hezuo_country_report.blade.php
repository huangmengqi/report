            ...
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <p class="card-description">
                        <a href="/admin/report/downloadhezuo?appid={{$appid}}&date={{$time1}}&gamename={{$gamename}}" class="btn btn-sm btn-gradient-success btn-icon-text">Export Excel</a>
                    </p>
                    <!-- <p class="card-description">
                        <a href="/admin/report/downloadmutihezuo?appid={{$appid}}&date={{$time1}}&today={{$time2}}&gamename={{$gamename}}" class="btn btn-sm btn-gradient-success btn-icon-text">Export Muti Days Excel</a>
                    </p> -->
                </nav>
            </div>
            <div class="row">
