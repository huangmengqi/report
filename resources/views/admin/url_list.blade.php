                                ...
                                <form class="forms-sample">
                                    <div class="form-group" style="width: 400px">
                                        <div class="input-group col-xs-3">
                                            <input type="text" style="width: 110px;height: calc(2.875rem + 2px);margin-right: 20px"  class="form-control required calendar1" @if($page_name) value="{{$page_name}}" @endif name="page_name" placeholder="请输入Page名称">
