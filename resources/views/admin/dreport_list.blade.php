            ...
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <p class="card-description">
                        <a href="/admin/report/downloadmutiday?appid={{$appid}}&date={{$time1}}&today={{$time2}}&gamename={{$gamename}}" class="btn btn-sm btn-gradient-success btn-icon-text">Export Muti Days Excel</a>
                    </p>
                </nav>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="col-lg-3">
                                <form class="forms-sample">
                                    <div class="form-group" style="width: 520px">
                                        ...
                                        <div class="input-group col-xs-3">
                                            <input type="text" style="width: 110px;height: calc(2.875rem + 2px);margin-right: 20px"  class="form-control required calendar1" @if($time1) value="{{$time1}}" @endif name="time1" placeholder="开始时间">
                                            <input type="text" style="width: 110px;height: calc(2.875rem + 2px);margin-right: 20px"  class="form-control calendar2" @if($time2) value="{{$time2}}" @endif name="time2" placeholder="结束时间">
                                ...
                                <div @if($appid != 143 && $appid != 150) style="display: none" @endif>
                                    <form class="forms-sample">
                            ...
                            <table class="table table-bordered" id="form-table1">
                                ...
                                @foreach($list as $k=>$v)
                                    <tr>
                                        ...
                                        <td>@php $total = $v->fb_ad_network_revenue+$v->is_revenue+$v->mp_revenue+$v->al_revenue+$v->am_revenue+$v->upltv; echo round($total-$v->cost,2); @endphp</td>
                                        ...
                                        <td>{{isset($v->fb_ad_network_revenue) ?$v->fb_ad_network_revenue+$v->upltv : '0.00'}}</td>
