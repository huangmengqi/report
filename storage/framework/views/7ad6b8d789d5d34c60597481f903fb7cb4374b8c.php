...
<!-- 内容区域 -->
                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/admin/report/uploadtoolxls" method='post' enctype="multipart/form-data">
                            	<?php echo csrf_field(); ?>
                                <input type="text" style="width: 210px;height: calc(2.875rem + 2px);margin-right: 20px"  class="form-control required calendar1"  value="选择日期" name="date" required><br>
    ...
    <script>
         function commit(){
            ...
            myRequest("/admin/report/uploadtoolxls","post",data,function(res){
                if(res.code == '200'){
                    layer.msg(res.msg)
                    setTimeout(function(){
