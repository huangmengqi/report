            ...
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <p class="card-description">
                        <a href="/admin/report/downloadcompared?month=<?php echo e($month); ?>&company=<?php echo e($company); ?>" class="btn btn-sm btn-gradient-success btn-icon-text">Export Excel</a>
                    </p>
                </nav>
                                ...
                                <div class="scroll-box">
                                    ...
                                    <?php $__currentLoopData = $spenddata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <?php if($v->difference < 0): ?> 
                                                <td class="red"><?php echo $v->difference;?></td>
                                            <?php else: ?>
                                                <td class="green"><?php echo $v->difference;?></td>
                                            <?php endif; ?>
