            ...
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <p class="card-description">
                        <a href="/admin/report/download?appid=<?php echo e($appid); ?>&date=<?php echo e($time1); ?>&gamename=<?php echo e($gamename); ?>" class="btn btn-sm btn-gradient-success btn-icon-text">Export Excel</a>
                    </p>
                    <p class="card-description">
                        <a href="/admin/report/downloadmuti?appid=<?php echo e($appid); ?>&date=<?php echo e($time1); ?>&today=<?php echo e($time2); ?>&gamename=<?php echo e($gamename); ?>" class="btn btn-sm btn-gradient-success btn-icon-text">Export Muti Days Excel</a>
                    </p>
                </nav>
            </div>
            <div class="row">
