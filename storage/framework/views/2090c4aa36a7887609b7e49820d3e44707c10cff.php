                            ...
                            <div class="col-lg-3">
                                <form class="forms-sample">
                                    <div class="form-group" style="width: 1000px">
                                        <div class="input-group col-xs-3">
                                            ...
                                            <input type="text" style="width: 110px;height: calc(2.875rem + 2px);margin-right: 20px"  class="form-control required calendar1"  value="<?php echo e($today); ?>" name="today" placeholder="按时间搜索">
                                            ...
                                            <select class="form-control form-control-lg" name="category" style="width: 150px;height: calc(2.875rem + 2px);margin-right: 20px">
                                                ...
                                                <?php $__currentLoopData = $catedata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option  <?php if($category): ?> value="<?php echo e($category); ?>" <?php endif; ?> ><?php echo e($v->category); ?></option>
                              ...
                              <table id="form-table" cellpadding="0" border="0" cellspacing="0">
                                ...
                                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($v->range); ?></td>
                                        <td><?php echo e($v->date); ?></td>
                                        <td><?php echo e($v->app_name); ?></td>
                                        <td><?php echo e($v->company); ?></td>

                                        <?php if($v->range_change == '下降'): ?> 
                                            <td class="red"><?php echo $v->range_change;?></td>
                                        <?php elseif($v->range_change == '上升'): ?>
                                            <td class="green"><?php echo $v->range_change;?></td>
                                        <?php else: ?>
                                            <td><?php echo '不变';?></td>
                                        <?php endif; ?>

                                        <?php if($v->range_change == '下降'): ?> 
                                            <td class="red"><?php echo $v->range_change_num;?></td>
                                        <?php elseif($v->range_change == '上升'): ?>
                                            <td class="green"><?php echo $v->range_change_num;?></td>
                                        <?php else: ?>
                                            <td><?php echo $v->range_change_num;?></td>
                                        <?php endif; ?>

                                        <td><?php echo e($v->category); ?></td>
                                        <td><?php echo e($v->star); ?></td>
                                        <td><?php echo e($v->create_date); ?></td>
                                        <td><?php echo e($v->update_date); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
    ...
    <script>
        ...
        function uploadxls(){
            layer.open({
                ...
                shade: 0.8,
                area: ['50%', '70%'],
                content: '/admin/report/uploadxls'
            });
        }
