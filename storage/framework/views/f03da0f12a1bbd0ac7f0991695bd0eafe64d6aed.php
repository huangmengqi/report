                                        ...
                                        <div class="input-group col-xs-3">
                                            <select class="form-control form-control-lg" name="appname" style="width: 150px;height: calc(2.875rem + 2px);margin-right: 20px">
                                                <?php $__currentLoopData = $gamelist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option  <?php if($appname == $v->name): ?> selected <?php endif; ?> value="<?php echo e($v->name); ?>"><?php echo e($v->name); ?></option>
                            ...
                            <!-- <table class="table table-bordered" > -->
                                ...
                                <div class="scroll-box">
                                    ...
                                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($v->app); ?></td>
                                            <td><?php echo e($v->COUNTRY_CODE); ?></td>
                                            <!-- <td><?php echo e($v->COUNTRY_NAME); ?></td> -->
                                            <td><?php echo e($v->AD_REQUESTS); ?></td>
                                            <td><?php echo e($v->AD_REQUESTS_COVERAGE); ?></td>
                                            <td><?php echo e($v->AD_REQUESTS_CTR); ?></td>
                                            <td><?php echo e($v->AD_REQUESTS_RPM); ?></td>
                                            <td><?php echo e($v->CLICKS); ?></td>
                                            <td><?php echo e($v->COST_PER_CLICK); ?></td>
                                            <td><?php echo e($v->EARNINGS); ?></td>
                                            <td><?php echo e($v->INDIVIDUAL_AD_IMPRESSIONS_CTR); ?></td>
                                            <td><?php echo e($v->INDIVIDUAL_AD_IMPRESSIONS_RPM); ?></td>
                                            <td><?php echo e($v->MATCHED_AD_REQUESTS); ?></td>
                                            <td><?php echo e($v->MATCHED_AD_REQUESTS_CTR); ?></td>
                                            <td><?php echo e($v->MATCHED_AD_REQUESTS_RPM); ?></td>
                                            <td><?php echo e($v->PAGE_VIEWS); ?></td>
                                            <td><?php echo e($v->PAGE_VIEWS_CTR); ?></td>
                                            <td><?php echo e($v->PAGE_VIEWS_RPM); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
                                </table>
