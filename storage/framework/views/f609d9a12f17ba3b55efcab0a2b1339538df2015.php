            ...
            <div class="page-header">
                ...
                <!-- <nav aria-label="breadcrumb">
                    <p class="card-description">
                        <a href="/admin/report/download?appid=<?php echo e($appid); ?>&date=<?php echo e($today); ?>&gamename=<?php echo e($gamename); ?>" class="btn btn-sm btn-gradient-success btn-icon-text">Export Excel</a>
                    </p>
                    <p class="card-description">
                        <a href="/admin/report/downloadmuti?appid=<?php echo e($appid); ?>&date=<?php echo e($today); ?>&today=<?php echo e($time2); ?>&gamename=<?php echo e($gamename); ?>" class="btn btn-sm btn-gradient-success btn-icon-text">Export Muti Days Excel</a>
                    </p>
                </nav> -->
            </div>
            <div class="row">
                                ...
                                <form class="forms-sample">
                                    <div class="form-group" style="width: 1000px">
                                        <div class="input-group col-xs-3">
                                            <input type="text" style="width: 110px;height: calc(2.875rem + 2px);margin-right: 20px"  class="form-control required calendar1" <?php if($today): ?> value="<?php echo e($today); ?>" <?php endif; ?> name="today" >
                                            <input type="text" style="width: 110px;height: calc(2.875rem + 2px);margin-right: 20px"  class="form-control required calendar2" <?php if($time2): ?> value="<?php echo e($time2); ?>" <?php endif; ?> name="time2" >
                            ...
                            <!-- <table class="table table-bordered" > -->
                                ...
                                <div class="scroll-box">
                                    ...
                                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo date('m-d',strtotime($today)).'~'.date('m-d',strtotime($time2));?></td> 
                                            <td><?php echo e($v->name); ?></td>
                                            <td><?php echo e($countryid); ?></td>
