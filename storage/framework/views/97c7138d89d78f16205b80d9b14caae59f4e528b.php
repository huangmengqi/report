...
<input type="text"  readonly style="width: 10rem;height: calc(2.875rem );margin-right: 20px"  class="form-control" name="date" id="demo" value="<?php echo e($time1); ?>  <?php echo e($time2); ?>" data-time1="<?php echo e($time1); ?>" data-time2="<?php echo e($time2); ?>"/>
                                    ...
                                    $('#demo').daterangepicker({
                                        ...
                                        "endDate": end,
                                            ...
                                            <select class="form-control form-control-lg" name="unit_name" style="width: 100px;height: calc(2.875rem + 2px);margin-right: 20px" >
                                                ...
                                                <option  <?php if($unit_name === 'Native-sp-main'): ?> selected <?php endif; ?> value="Native-sp-main">Native-sp-main</option>
                                                <option  <?php if($unit_name == 'Interstitial'): ?> selected <?php endif; ?> value="Interstitial">Interstitial</option>
                                            </select>
                                ...
                                <div class="scroll-box">
                                    ...
                                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($v->unit_name); ?></td>
                                            <td><?php echo e($v->request); ?></td>
                                            <td><?php echo e($v->impressions); ?></td>
                                            <td><?php echo e($v->clicks); ?></td>
                                            <?php 
                                                $ctr = $v->ctr*100;
                                                $request = $v->request; 
                                            ?> 
                                            <?php if($ctr >= 15 && $request > 100): ?> 
                            ...
                            <input type="hidden" value='<?php echo e($list->total()); ?>' name="total" id="total" />  
