                                ...
                                <div class="scroll-box">
                                    ...
                                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($v->ad_account_name); ?></td>
                                            <td><?php echo e($v->report_start); ?></td>
                                            <td><?php echo e($v->report_end); ?></td>
                                            <td><?php echo e($v->account_name); ?></td>
                                            <td><?php echo e($v->country_code); ?></td>
                                            <td><?php echo e($v->impressions); ?></td>
                                            <td><?php echo e($v->clicks); ?></td>
                                            <td><?php echo e($v->cpr); ?></td>
                                            <td><?php echo e($v->install); ?></td>
                                            <td><?php echo e($v->cpi); ?></td>
                                            <td><?php echo e($v->result_indicator); ?></td>
                                            <td><?php echo e($v->spend); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
                                </table>
