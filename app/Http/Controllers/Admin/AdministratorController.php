...
{
	protected $setting = [
        'app_id' => '349283984208-ps8arphrdg608ne162bi14hsfrac422j.apps.googleusercontent.com',  //客户端ID
        'redirect_uri' => 'http://a.mobhe.cn',     //回调地址
        'app_secret' => 'V4zVEIryQH-M_W8k952owyye',             //客户端密钥
    ];
    ...
    public function administratorAdd(Request $request){
        if($request->isMethod('post')){
            ...
            $data = [
                'avatar'=>"/uploads/avatar/20190304/5c7d033247dd6.png",
